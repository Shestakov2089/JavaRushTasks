...
public class Solution {
    ...
    public static void universalMethod(int a, String b){
    }
    public static void universalMethod(boolean a){
    }
    public static void universalMethod(float a){
    }
    public static void universalMethod(int a, boolean b){
    }
    public static void universalMethod(String a, boolean b){
    }
    public static void universalMethod(int a, double b){
    }
    public static void universalMethod(int a, float b){
    }
